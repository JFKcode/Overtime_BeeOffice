...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        # Numer id
        tk.Label(self, text="User number").grid(row=0, column=0, padx=5, pady=5, sticky="e")
        ...
        # Data
        tk.Label(self, text="Choose a day").grid(row=1, column=0, padx=5, pady=5, sticky="e")
        self.date_entry = self.logic.create_date_entry()
        self.date_entry.grid(row=1, column=1, padx=5, pady=5, sticky="w")

        # Time from
        tk.Label(self, text="Time from").grid(row=2, column=0, padx=5, pady=5, sticky="e")
        ...
        # Time to
        tk.Label(self, text="Time to").grid(row=3, column=0, padx=5, pady=5, sticky="e")
        ...
        # Add data
        self.add_button = ttk.Button(self, text="Add data", command=self.logic.add_data)
        self.add_button.grid(row=4, column=0, columnspan=3, pady=(10, 5))

        # Removal from the list
        self.delete_button = ttk.Button(self, text="Remove selected data", command=self.logic.delete_data)
        self.delete_button.grid(row=5, column=0, columnspan=3, pady=(5, 5))

        # Launching the script and adding overtime
        self.overtime_button = ttk.Button(self, text="Add overtime", command=self.logic.add_overtime)
